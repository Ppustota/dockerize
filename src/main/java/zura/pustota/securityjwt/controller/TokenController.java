...
import zura.pustota.securityjwt.utility.RefreshTokenUtil;
    ...
    public void refreshToken(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(authorizationHeader!=null && authorizationHeader.startsWith("Bearer ")){
                try{
                    ...
                    String username = RefreshTokenUtil.decodeUsername(refreshToken, "secret");
                    User user = service.getUser(username);
                    String accessToken = RefreshTokenUtil.jwtTokenRoleBuilder(request, RefreshTokenUtil.getAlgorithm("secret"), user);
